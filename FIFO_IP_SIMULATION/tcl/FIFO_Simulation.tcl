...
################################################################
# This is a generated script based on design: FIFO_Simulation
#
...
# source FIFO_Simulation_script.tcl
...
set design_name FIFO_Simulation
...
proc create_root_design { parentCell } {
  ...
  set rd_rst_0 [ create_bd_port -dir I rd_rst_0 ]
  ...
  connect_bd_net -net Counter_0_count_out [get_bd_pins Counter_0/count_out] [get_bd_pins fifo_generator_0/din]
  connect_bd_net -net Counter_0_valid_out [get_bd_pins Counter_0/valid_out] [get_bd_pins fifo_generator_0/wr_en]
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins Counter_0/clk] [get_bd_pins fifo_generator_0/wr_clk]
  ...
  connect_bd_net -net fifo_generator_0_full [get_bd_ports full_0] [get_bd_pins Counter_0/full] [get_bd_pins fifo_generator_0/full]
  ...
  connect_bd_net -net rd_rst_0_1 [get_bd_ports rd_rst_0] [get_bd_pins fifo_generator_0/rd_rst]
  connect_bd_net -net reset_0_1 [get_bd_ports reset_0] [get_bd_pins Counter_0/reset] [get_bd_pins fifo_generator_0/wr_rst]
