...
#
# DMA_S2MM.tcl: Tcl script for re-creating project 'DMA_S2MM'
#
# Generated by Vivado on Wed Jul 22 07:57:14 +0300 2026
...
#
# 1. This project restoration tcl script (DMA_S2MM.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/Zeerak_Office/Desktop/DMA_S2MM/DMA_S2MM.srcs/sources_1/bd/s2mm_dma/hdl/s2mm_dma_wrapper.v"
#    "C:/Users/Zeerak_Office/Desktop/DMA_S2MM/DMA_S2MM.srcs/sources_1/new/data_generator.v"
#
...
set files [list \
 [file normalize "${origin_dir}/DMA_S2MM.srcs/sources_1/bd/s2mm_dma/hdl/s2mm_dma_wrapper.v"]\
 [file normalize "${origin_dir}/DMA_S2MM.srcs/sources_1/new/data_generator.v"]\
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "s2mm_dma_wrapper" -objects $obj
...
# Proc to create BD s2mm_dma
proc cr_bd_s2mm_dma { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name s2mm_dma
  ...
  connect_bd_net -net axi_dma_0_s_axis_s2mm_tready [get_bd_pins axi_dma_0/s_axis_s2mm_tready] [get_bd_pins axi_dma_0/s_axis_s2mm_tvalid] [get_bd_pins c_counter_binary_0/CE] [get_bd_pins ila_0/probe0]
  connect_bd_net -net c_addsub_0_S [get_bd_pins axi_dma_0/s_axis_s2mm_tdata] [get_bd_pins c_addsub_0/S]
  connect_bd_net -net data_generator_0_data [get_bd_pins c_addsub_0/A] [get_bd_pins c_counter_binary_0/Q] [get_bd_pins ila_0/probe1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
...
# End of cr_bd_s2mm_dma()
cr_bd_s2mm_dma ""
set_property REGISTERED_WITH_MANAGER "1" [get_files s2mm_dma.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files s2mm_dma.bd ] 
