...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Address_Generator_0_Addr [get_bd_pins Address_Generator_0/Addr] [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins system_ila_1/probe0]
  connect_bd_net -net Address_Generator_0_valid [get_bd_pins Address_Generator_0/valid] [get_bd_pins system_ila_1/probe2]
  connect_bd_net -net axi_bram_ctrl_0_bram_addr_a [get_bd_pins axi_bram_ctrl_0/bram_addr_a] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net axi_bram_ctrl_0_bram_clk_a [get_bd_pins axi_bram_ctrl_0/bram_clk_a] [get_bd_pins axi_bram_ctrl_0_bram/clka] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net axi_bram_ctrl_0_bram_douta [get_bd_pins axi_bram_ctrl_0/bram_rddata_a] [get_bd_pins axi_bram_ctrl_0_bram/douta] [get_bd_pins system_ila_0/probe2]
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb [get_bd_pins axi_bram_ctrl_0_bram/doutb] [get_bd_pins system_ila_1/probe1]
  connect_bd_net -net axi_bram_ctrl_0_bram_en_a [get_bd_pins axi_bram_ctrl_0/bram_en_a] [get_bd_pins axi_bram_ctrl_0_bram/ena] [get_bd_pins system_ila_0/probe3]
  connect_bd_net -net axi_bram_ctrl_0_bram_we_a [get_bd_pins axi_bram_ctrl_0/bram_we_a] [get_bd_pins util_reduced_logic_0/Op1]
  connect_bd_net -net axi_bram_ctrl_0_bram_wrdata_a [get_bd_pins axi_bram_ctrl_0/bram_wrdata_a] [get_bd_pins axi_bram_ctrl_0_bram/dina] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins xlslice_2/Din]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Address_Generator_0/clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila_1/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins Address_Generator_0/reset_n] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net util_reduced_logic_0_Res [get_bd_pins axi_bram_ctrl_0_bram/wea] [get_bd_pins system_ila_0/probe4] [get_bd_pins util_reduced_logic_0/Res]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins axi_bram_ctrl_0_bram/addra] [get_bd_pins system_ila_0/probe0] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins Address_Generator_0/Trigger] [get_bd_pins xlslice_2/Dout]
